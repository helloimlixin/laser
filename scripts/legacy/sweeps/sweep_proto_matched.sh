...
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_proto_matched.sh
#   CASE_FILTER=fast_r_proto ./scripts/legacy/sweeps/sweep_proto_matched.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_proto_matched.sh
