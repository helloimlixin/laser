...
def laser_model_kwargs(model_cfg: Any, train_cfg: Any, *, in_channels: int, image_size) -> dict:
    ...
    return {
        ...
        "audio_adversarial_type": str(_cfg_get(model_cfg, "audio_adversarial_type", "hifigan")),
        "audio_disc_periods": tuple(_cfg_get(model_cfg, "audio_disc_periods", (2, 3, 5, 7, 11))),
        ...
        "optimizer_beta2": _cfg_get(train_cfg, "beta2", 0.999),
