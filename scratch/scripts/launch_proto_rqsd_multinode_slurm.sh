...
OUT_DIR="${OUT_DIR:-/cache/home/$USER/runs/laser_celeba${IMAGE_SIZE}_quantized}"
...
STAGE2_SAMPLE_SELECTION_MODE="${STAGE2_SAMPLE_SELECTION_MODE:-quality_only}"
...
STAGE2_SAMPLE_SELECTION_MODE='"$STAGE2_SAMPLE_SELECTION_MODE"'
