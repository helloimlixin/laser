...
export STAGE2_SAMPLE_START_STEP="${STAGE2_SAMPLE_START_STEP:-0}"
...
export STAGE2_ARCH="${STAGE2_ARCH:-spatial_depth}"
export TF_D_MODEL="${TF_D_MODEL:-512}"
export TF_HEADS="${TF_HEADS:-8}"
export TF_LAYERS="${TF_LAYERS:-12}"
export TF_FF="${TF_FF:-1024}"
export TF_DROPOUT="${TF_DROPOUT:-0.1}"
export TF_GLOBAL_TOKENS="${TF_GLOBAL_TOKENS:-0}"
