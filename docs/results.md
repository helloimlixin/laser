> Historical experiment results and recipes, preserved from the previous README.
> For current launch commands, see [README](../README.md). Old script commands
> below refer to their original locations; the scripts are now in `archive/scripts/`.
...
[`run_ffhq_a2048_k2_levelwise_var_pipeline.sh`](../archive/scripts/run_ffhq_a2048_k2_levelwise_var_pipeline.sh).
...
![Aligned FFHQ originals on the left and direct Stage-1 reconstructions on the right](assets/ffhq-a2048-k2-stage1-originals-vs-reconstructions-8x8.jpg)
...
![Aligned CelebA-HQ originals on the left and direct Stage-1 reconstructions on the right](assets/celebahq-a2048-k2-stage1-originals-vs-reconstructions-8x8.jpg)
...
[`evaluate_upstream_laser_rfid.py`](../archive/scripts/evaluate_upstream_laser_rfid.py).
...
| [`scripts/train_official_rqtransformer_laser_stage2.py`](../src/training/rqtransformer.py) | Compound RQ-Transformer training and sampling |
