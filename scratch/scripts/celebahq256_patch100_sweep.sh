...
OUT_ROOT="${OUT_ROOT:-/scratch/$USER/runs/celebahq256_patch100_sweep}"
...
RUN_PREFIX="${RUN_PREFIX:-celebahq256_patch100}"
JOB_PREFIX="${JOB_PREFIX:-chq256-p100}"
...
core_cases=(
  "base|false|4096|16|256|8.0|uniform|0.0"
  "widek|false|4096|24|256|8.0|uniform|0.0"
  "widea|false|6144|16|256|8.0|uniform|0.0"
  "qbase|true|4096|16|512|8.0|uniform|0.0"
)

expanded_cases=(
  "wideak|false|6144|24|256|8.0|uniform|0.0"
  "qwide|true|6144|16|512|8.0|uniform|0.0"
  "qwidek|true|4096|24|512|8.0|uniform|0.0"
)
