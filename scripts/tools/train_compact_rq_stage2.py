#!/usr/bin/env python3
"""Fresh original Church RQTransformer with the calibrated compact atom-specific book."""
import argparse
...
from src.scaled_atom_training import (accumulated_update,
            ...
            run=wandb.init(project='laser',entity='helloimlixin-rutgers',id=args.run_id,
                name=args.run_id,resume='never',dir=str(out),config={
                    **OmegaConf.to_container(config,resolve=True),
                    'pipeline':'frozen-laser-compact-adaptive-rq2-original-rqtransformer',
