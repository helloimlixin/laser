...
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_quantized_coeffs_patched.sh
#   CASE_FILTER=p4s4_k16_q512_large ./scripts/legacy/sweeps/sweep_quantized_coeffs_patched.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_quantized_coeffs_patched.sh
