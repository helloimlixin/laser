...
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_quantized_coeffs.sh
#   CASE_FILTER=q512_uniform_large ./scripts/legacy/sweeps/sweep_quantized_coeffs.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_quantized_coeffs.sh
