...
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_patch_quant_v3.sh
#   CASE_FILTER=p4s4_base ./scripts/legacy/sweeps/sweep_patch_quant_v3.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_patch_quant_v3.sh
