...
#   3. legacy/compat/train_ar.py - stage-2 autoregressive prior
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_patch_quant_v2.sh                             # CelebA 128
#   IMAGE_SIZE=256 DATA_DIR=/scratch/$USER/datasets/celebahq_packed_256 \
#       ./scripts/legacy/sweeps/sweep_patch_quant_v2.sh
#   CASE_FILTER=fast_r,p4s2_k8_d512_r ./scripts/legacy/sweeps/sweep_patch_quant_v2.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_patch_quant_v2.sh                   # preview
...
python legacy/compat/train_ar.py \\
