...
OUT_ROOT="${OUT_ROOT:-/scratch/$USER/runs/celebahq256_patch_nooverlap_sweep}"
...
STAGE2_WARMUP_STEPS="${STAGE2_WARMUP_STEPS:-3000}"
...
RUN_PREFIX="${RUN_PREFIX:-celebahq256_patch_noov_50s1_200s2}"
JOB_PREFIX="${JOB_PREFIX:-chq256-pno}"
...
cases=(
  "p4r|4|4|false|4096|4|256|8.0|16|16|6e-4"
  "p4q|4|4|true|4096|4|512|8.0|16|16|6e-4"
  "p8r|8|8|false|4096|16|256|8.0|24|24|8e-4"
  "p8q|8|8|true|4096|16|512|8.0|24|24|8e-4"
)
