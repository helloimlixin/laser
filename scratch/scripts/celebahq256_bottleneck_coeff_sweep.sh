...
RUN_PREFIX="${RUN_PREFIX:-celebahq256_bneck10_q20b2048}"
...
families=(
  "patchq|true|true|${PATCH_AE_NUM_DOWNSAMPLES}|${PATCH_NUM_HIDDENS}|${PATCH_NUM_RES_HIDDENS}|${PATCH_NUM_RES_LAYERS}|${PATCH_SIZE}|${PATCH_STRIDE}|2048|20.0|uniform|0.0"
  ...
  "latent8q|false|true|${LATENT8_AE_NUM_DOWNSAMPLES}|${LATENT8_NUM_HIDDENS}|${LATENT8_NUM_RES_HIDDENS}|${LATENT8_NUM_RES_LAYERS}|${PATCH_SIZE}|${PATCH_STRIDE}|2048|20.0|uniform|0.0"
