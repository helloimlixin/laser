...
#
# Legacy usage:
#   ./scripts/legacy/sweeps/sweep_proto_matched_full.sh
#   CASE_FILTER=fast_r ./scripts/legacy/sweeps/sweep_proto_matched_full.sh
#   DRY_RUN=1 ./scripts/legacy/sweeps/sweep_proto_matched_full.sh
