...
def laser_model_kwargs(model_cfg: Any, train_cfg: Any, *, in_channels: int, image_size) -> dict:
    ...
    return {
        ...
        "discriminator_channels": int(_cfg_get(model_cfg, "discriminator_channels", 64)),
        ...
        "dead_atom_revival_steps": int(_cfg_get(model_cfg, "dead_atom_revival_steps", 0)),
        ...
        "online_ksvd_enabled": bool(_cfg_get(model_cfg, "online_ksvd_enabled", False)),
        "online_ksvd_start_step": int(_cfg_get(model_cfg, "online_ksvd_start_step", 0)),
        "online_ksvd_interval_steps": int(_cfg_get(model_cfg, "online_ksvd_interval_steps", 0)),
        "online_ksvd_stop_step": _cfg_get(model_cfg, "online_ksvd_stop_step", None),
        "online_ksvd_max_samples": int(_cfg_get(model_cfg, "online_ksvd_max_samples", 512)),
        "online_ksvd_max_atoms": int(_cfg_get(model_cfg, "online_ksvd_max_atoms", 256)),
        "online_ksvd_blend": float(_cfg_get(model_cfg, "online_ksvd_blend", 0.25)),
