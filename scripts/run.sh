...
print_summary() {
  ...
  echo "stage1_post_rfid:   $S1_COMPUTE_RFID_AFTER_FIT (split=$S1_RFID_SPLIT max_samples=$S1_RFID_MAX_SAMPLES batch=$S1_RFID_BATCH_SIZE)"
...
run_stage1() {
  local -a args=(
    ...
    "train.compute_rfid_after_fit=$S1_COMPUTE_RFID_AFTER_FIT"
    "train.rfid_split=$S1_RFID_SPLIT"
    "train.rfid_batch_size=$S1_RFID_BATCH_SIZE"
    "train.rfid_num_workers=$S1_RFID_NUM_WORKERS"
    "train.rfid_max_samples=$S1_RFID_MAX_SAMPLES"
    "train.rfid_device=$S1_RFID_DEVICE"
