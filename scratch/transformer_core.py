"""Shared causal-transformer utilities for scratch-stage priors.

These helpers keep the low-level attention/cache plumbing in one place so the
model files can stay focused on token layout and sampling behavior.
"""
...
def init_transformer_module_weights(module: nn.Module) -> None:
    """GPT-style weight init shared by the scratch transformer models."""
